const MODAL_ACTIVE_CLASS_NAME = 'modal__active';
...
const closeBtns = document.querySelectorAll('.clouse__button');
...
function showGooseAnim() {
    const targetContainer = document.querySelector('.modal__form');
